...
CREATE TABLE Activity (
    ...
    FOREIGN KEY (activity_id) REFERENCES HRdata(activity_id),
...
INSERT INTO Activity (user_id, activity_type, duration, notes, activity_date) VALUES
(1, 'Ice hockey', 3000, 'High intensity training, backcheck', '2024-01-10 18:00:00'),
(1, 'Weight Training', 5400, 'Morning lift, legs feel like hell', '2024-01-11 08:30:00'),
(2, 'Running', 1800, 'Easy run', '2023-12-11 21:30:00');

/*-- Insert testdata in HRdata
INSERT INTO HRdata (user_id, average_hr, light_hr_duration, moderate_hr_duration, intense_hr_duration, peak_hr_duration) VALUES
(1, 129.0, 497 ,984, 808, 711),
(2, 87.3, 0, 1800, 0, 0),
(1, 84.5, 1000, 2000, 2000, 400);
